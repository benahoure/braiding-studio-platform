        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative flex justify-center lg:justify-start">
            ...
            >
              ...
              <div className="mt-2" style={{ fontSize: '0.75rem', color: 'rgba(251,247,242,0.38)' }}>
          ...
          <div>
            ...
            <div className="space-y-5 leading-relaxed" style={{ fontSize: '0.92rem', color: 'var(--muted)' }}>
              <p>
            ...
            <div className="grid grid-cols-3 gap-5 mt-10">
              {[
                ...
                <div key={label} className="text-center">
                  ...
                  <p className="font-medium mb-1" style={{ fontSize: '0.85rem', color: 'var(--onyx)' }}>
                    {label}
                  </p>
